...
import { ModalType, useModal } from '@/hooks/useModalHook';
...
const ServerChannel: FC<ServerChannelProps> = ({channel,server,role}) => {
  ...
  const Icon=iconMapx[channel.type];
  ...
  return (
    ...
    >
      <Icon className="flex-shrink-0 w-5 h-6 text-zinc-500 dark:text-zinc-400"/>
